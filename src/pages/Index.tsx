  ...
  return (
    <div className="min-h-screen bg-[#F7F9FC] font-golos text-[#111827]">
      <SEO
        ...
        description="ProFiX — IT-компания в Якутске. Внедрение и обслуживание 1С, регистрация онлайн-касс (ККТ), ТСД, ремонт компьютеров и ноутбуков, видеонаблюдение, монтаж сетей, заправка картриджей. Работаем по всей Республике Саха (Якутия)."
