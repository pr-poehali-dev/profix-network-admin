...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F7F9FC] font-golos text-[#111827]">
      ...
      {/* CONTACT INFO BAR */}
      <section className="bg-[#3ca615] py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-white">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs text-white/60 mb-0.5">Адрес</p>
                <p className="font-medium text-sm">г. Якутск, ул. Халтурина, 6</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <Icon name="Phone" size={20} className="text-white/70 shrink-0 mt-0.5" />
              <div>
                <p className="text-xs text-white/60 mb-0.5">Телефон</p>
                <a href="tel:+79142727187" className="font-medium text-sm hover:underline">+7 (914) 272-71-87</a>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="mailto:727187@it-profix.ru" className="font-medium text-sm hover:underline">727187@it-profix.ru</a>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <Icon name="Clock" size={20} className="text-white/70 shrink-0 mt-0.5" />
              <div>
                <p className="text-xs text-white/60 mb-0.5">Режим работы</p>
                <p className="font-medium text-sm">Пн–Сб: 9:00 – 19:00</p>
              </div>
            </div>
          </div>
        </div>
