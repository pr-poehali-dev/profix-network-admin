...
const carouselSlides = [
  ...
  { img: "https://cdn.poehali.dev/files/070109ef-61c1-4a96-92b6-535580f54fb8.jpg", title: "ТСД для Честного знака и склада", desc: "Терминалы сбора данных для маркировки и учёта товаров на складе." },
  { img: "https://cdn.poehali.dev/files/df41d772-4b54-4024-83af-a46c17abcd61.jpg", title: "Сенсорные моноблоки POScenter", desc: "Автоматизация розничных продаж, продуктовых магазинов и кафе." },
