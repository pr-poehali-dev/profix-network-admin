          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <p className="text-[#4B5563] leading-relaxed mb-6">
                {str("about.text1", "Компания ProFiX работает в Якутске уже более 15 лет. Мы специализируемся на полном спектре IT-услуг: от ремонта техники до построения корпоративных сетей.")}
              </p>
