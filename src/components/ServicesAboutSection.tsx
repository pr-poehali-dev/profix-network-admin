...
const DEFAULT_SERVICES = [
  { icon: "Monitor", title: "1С сопровождение", desc: "Установка, настройка, обновление и техническая поддержка программ 1С для вашего бизнеса." },
  { icon: "Network", title: "Монтаж и администрирование сетей", desc: "Проектирование, прокладка и обслуживание локальных сетей любой сложности." },
  { icon: "Camera", title: "Видеонаблюдение", desc: "Установка и настройка систем видеонаблюдения для офисов, магазинов и производств." },
  { icon: "Cpu", title: "Ремонт компьютеров и ноутбуков", desc: "Диагностика и ремонт любой сложности: замена комплектующих, восстановление данных." },
  { icon: "Printer", title: "Заправка картриджей", desc: "Быстрая и качественная заправка картриджей для всех популярных марок принтеров." },
  { icon: "Shield", title: "IT-безопасность", desc: "Настройка антивирусной защиты, резервное копирование, защита корпоративных данных." },
];
      ...
      <section id="services" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="font-oswald text-4xl font-bold text-[#0D1B2A]">{str("services.title", "НАШИ УСЛУГИ")}</h2>
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <h2 className="font-oswald text-4xl font-bold text-[#0D1B2A] mb-6">
                {str("about.title", "НАДЁЖНЫЙ IT-ПАРТНЁР В ЯКУТСКЕ")}
              </h2>
              <p className="text-[#4B5563] leading-relaxed mb-6">
                {str("about.text1", "Компания ПРОФИКС работает в Якутске уже более 15 лет. Мы специализируемся на полном спектре IT-услуг: от ремонта техники до построения корпоративных сетей.")}
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-white">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-medium text-base">{str("contacts.address", "г. Якутск, ул. Халтурина, 6")}</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href={`tel:${str("contacts.phone", "+79142727187").replace(/\D/g,"")}`} className="font-medium text-base hover:underline">{str("contacts.phone", "+7 (914) 272-71-87")}</a>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href={`mailto:${str("contacts.email", "727187@it-profix.ru")}`} className="font-medium text-base hover:underline">{str("contacts.email", "727187@it-profix.ru")}</a>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-medium text-base">{str("contacts.hours", "Пн–Сб: 9:00 – 19:00")}</p>
              </div>
            </div>
          </div>
        </div>
