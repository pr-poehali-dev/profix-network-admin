      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-500 text-sm">{str("contacts.address", "г. Якутск, ул. Халтурина, д. 6")}</p>
          </div>
          <a
            href={str("contacts.map_url", "https://yandex.ru/map-widget/v1/?ll=129.736301%2C62.047174&z=17&pt=129.736301%2C62.047174%2Cpm2rdm&l=map")}
            target="_blank"
        ...
        <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-100" style={{ height: "400px" }}>
          <iframe
            src={str("contacts.map_url", "https://yandex.ru/map-widget/v1/?ll=129.736301%2C62.047174&z=17&pt=129.736301%2C62.047174%2Cpm2rdm&l=map")}
            width="100%"
            height="100%"
            frameBorder="0"
            allowFullScreen
        ...
        <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="flex items-start gap-3 bg-[#F7F9FC] rounded-2xl p-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">{str("contacts.address", "г. Якутск, ул. Халтурина, д. 6")}</p>
            </div>
          </div>
          <div className="flex items-start gap-3 bg-[#F7F9FC] rounded-2xl p-4">
            <div className="w-9 h-9 rounded-xl bg-[#edf7e8] flex items-center justify-center shrink-0">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">{str("contacts.hours", "Пн–Пт: 9:00 – 18:00")}</p>
            </div>
          </div>
          <div className="flex items-start gap-3 bg-[#F7F9FC] rounded-2xl p-4">
            <div className="w-9 h-9 rounded-xl bg-[#edf7e8] flex items-center justify-center shrink-0">
            ...
            <div>
              ...
              <a href={str("contacts.phone_href", "tel:+79142727187")} className="text-xs text-[#3ca615] font-medium">{str("contacts.phone", "+7 (914) 272-71-87")}</a>
            </div>
          </div>
        </div>
      </div>
