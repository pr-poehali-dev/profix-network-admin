    ...
    <section className="bg-white py-14">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
          ...
          <a
            href={str("contacts.map_url", "https://yandex.ru/maps/org/profiks_/1224885547/")}
            target="_blank"
        ...
        <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-100" style={{ height: "400px" }}>
          <iframe
            src={str("contacts.map_embed_url", "https://yandex.ru/map-widget/v1/?ll=129.736899%2C62.047287&z=18&pt=129.736899%2C62.047287%2Cpm2rdm&l=map&oid=1224885547&ol=biz")}
            width="100%"
            height="100%"
            frameBorder="0"
            allowFullScreen
