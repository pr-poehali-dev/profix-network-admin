"""
CRM авторизация: клиенты, менеджеры, техники — OTP, пароль, восстановление пароля, обложка профиля. v8
"""
import json
import os
import secrets
...
def storage_error_text(e: Exception) -> str:
    ...
    if "402" in msg or "Payment Required" in msg:
        return ("Файловое хранилище проекта сейчас не принимает файлы. "
                "Это ограничение платформы, а не сайта — обратитесь в поддержку poehali.dev.")
